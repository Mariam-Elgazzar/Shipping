...
export class CreateGovernmentComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    const governmentData = {
      ...
      GovernmentName: this.governmentForm.value.GovernmentName.trim(),
      cost: this.governmentForm.value.cost.trim(),
      pickupCost: this.governmentForm.value.pickupCost.trim(),
  ...
  get GovernmentGovernmentNameControl() {
    return this.governmentForm.get('GovernmentName');
  }
